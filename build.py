...
############################Set input options######################
try:
	opts, args = getopt.getopt(sys.argv[1:],"ht:n:rm:p:o:d:k:v",["pos=","neg=","noblast","no_ff","qcov_hsp=","threads=","db=","outdir=","model=","num_trees=","remove_temp","pos_blastres=","neg_blastres=","min_len="])
...
if (os.path.isfile(model_file) ):
	...
	opt=raw_input('Replace model (y/n):')
	if opt=='n':
		sys.exit(0)
